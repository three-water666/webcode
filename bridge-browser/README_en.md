...
## Introduction
**webcode bridge** is the connector that links Web AI Chatbots (Gemini, ChatGPT, DeepSeek, Qwen, etc.) to your local VS Code environment. It intercepts specific AI tool calls and securely forwards them to your local VS Code server, allowing the cloud AI to "see" and "operate" on your local projects.
...
3. **Auto Connect**: Open Gemini, Qwen, or other supported AI pages from webcode. The extension will automatically detect and connect to the local service (the icon will turn green).
