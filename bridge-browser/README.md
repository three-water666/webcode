...
## 简介
**webcode bridge** 是连接 Web AI（如 Gemini、ChatGPT、DeepSeek、千问）与本地 VS Code 环境的桥梁。它负责拦截特定的 AI 工具调用请求，并将其安全地转发给本地的 VS Code 服务器，从而让云端 AI 能够“看见”并“操作”您的本地项目。
...
3. **自动连接**: 从 webcode 打开 Gemini、Qwen 或其他支持的 AI 网页。插件会自动检测并连接到本地服务（图标变绿）。
