...
| `get_project_context` | Summarizes the current workspace folder name, Git repository status, two-level project structure, and 5 recent commits for the initialization prompt; the project structure shows at most 100 entries, and generated and VCS folders are shown but not expanded. |
