...
webcode 用来把 ChatGPT、Gemini、DeepSeek 这类网页 AI，接到 VS Code 中暴露出来的本地 MCP 工具上。
...
第一次使用前，需要把 webcode 的初始化提示词加到你使用的 AI 产品里。

1. 点击浏览器工具栏中的 webcode 扩展图标。
